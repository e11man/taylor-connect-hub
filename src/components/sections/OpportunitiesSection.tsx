            ...
            >
              <div className="bg-white rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 border-2 border-gray-200 hover:border-[#00AFCE] hover:shadow-lg transition-all duration-300 h-full flex flex-col min-h-[350px] sm:min-h-[380px] md:min-h-[400px]">
                ...
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-lg md:text-xl font-montserrat font-bold text-primary group-hover:text-[#00AFCE] transition-all duration-300 line-clamp-2 flex-1">
                    {event.title}
                  </h3>
                  {event.isFull && (
                ...
                <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                  ...
                  <div className="flex items-center gap-2 md:gap-3 text-xs md:text-sm">
                    ...
                    <AddressLink address={event.location} className="text-muted-foreground truncate" truncate />
                  </div>
