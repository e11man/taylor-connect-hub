      ...
      <div className="container-custom">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <AnimatedSection variant="fade" delay={0.2}>
            ...
            <AnimatedText variant="slideUp" delay={1.2}>
          ...
          {/* Stats Section */}
          <AnimatedSection variant="stagger" delay={1.6}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 text-center transition-all duration-500 hover:shadow-xl overflow-hidden">
                    <motion.div 
                      className="relative flex justify-center mb-6"
                      whileHover={{ scale: 1.1, rotateY: 10 }}
                      transition={{ duration: 0.3 }}
                    >
                      <div className="w-12 h-12 md:w-16 md:h-16 bg-[#00AFCE] rounded-2xl flex items-center justify-center shadow-md">
                        <stat.icon className="w-6 h-6 md:w-8 md:h-8 text-white" />
                      </div>
                    </motion.div>
                    <motion.div 
                      className="relative text-4xl md:text-5xl font-montserrat font-black mb-2 md:mb-3 text-secondary"
                      whileHover={{ scale: 1.05 }}
                      transition={{ duration: 0.2 }}
                    >
                      {stat.value}
                    </motion.div>
                    <div className="relative text-base md:text-lg text-gray-600 font-montserrat font-semibold tracking-wide">
                      {stat.label}
                    </div>
                  </div>
                </AnimatedCard>
